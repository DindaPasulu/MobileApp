...
public class PlayMusicActivity extends AppCompatActivity {
    ...
    TextView elapsedTimeLabel, remainingTimeLabel, tvSongTitle, tvSongSinger;
    MediaPlayer mp;
    int totalTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSongSinger = findViewById(R.id.song_singer);
        ...
        //set song title
        tvSongTitle.setText(strTitle);
        //set song singer
        tvSongSinger.setText(strSinger);

        tvSongTitle.setEllipsize(TextUtils.TruncateAt.MARQUEE);
